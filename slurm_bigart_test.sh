...
singularity exec --nv deoxys-beta.sif python -u test_experiment_external.py config/bigart_test_$SLURM_ARRAY_TASK_ID.json $HOME/performance/bigart_test_$SLURM_ARRAY_TASK_ID $HOME/bigart_models/bigart_$SLURM_ARRAY_TASK_ID.h5
