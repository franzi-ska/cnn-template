...
singularity exec --nv deoxys-beta.sif python -u test_experiment_external.py $HOME/bigart_models/bigart_$SLURM_ARRAY_TASK_ID.h5 $HOME/performance/bigart_$SLURM_ARRAY_TASK_ID config/bigart_test_$SLURM_ARRAY_TASK_ID.json 
